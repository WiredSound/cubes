...
namespace world {
    ...
    public:
        ...
        void provide_chunk(glm::ivec3 coords, Chunk chunk, render::WorldRenderer& renderer);
        ...
        void provide_chunks(std::unordered_map<glm::ivec3, Chunk> coords_chunks, render::WorldRenderer& renderer);
    ...
    private:
        ...
        void update_chunk_mesh(glm::ivec3 coords, render::WorldRenderer& renderer);
